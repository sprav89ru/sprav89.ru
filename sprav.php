...
<?php
	...
	//echo 'PATH  = '.PATH; http://localhost/sprav89.ru
...
function roditel0($mysqli)  // выводит группы 1-го уровня + 2 уровня 
	{	
...
function roditel1($mysqli, $idr)  // выводит группу 1-го уровня + элементы
	{	
...
function roditel2($mysqli,$idr)//Элементы группы $idr
	{
...
function sprav($mysqli,$id) // Данные элемента с id
{
	...
	{ //цикл по телефонам
			...
			elseif ($row['format_vyvoda_strok']=='19_sayt_') {
				...
				echo '<tr>';
				echo '<td class="sayt_"></td><td class="sayt"><a class="elpochta_a" href="http://'.$sayt.'">'.$sayt.'</a></td>';
				echo '</tr>';
				}
			...
			elseif ($row['format_vyvoda_strok']=='27_skayp') {
				...
				echo '<tr>';
				echo '<td class="skype_table_">Skype:</td><td class="skype"><a class="elpochta_a" href="skype:'.$Skype.'?call">'.$Skype.'</a></td>';
				echo '</tr>';
				}
			else {
				echo '<tr>';
